...
\clubpenalty=10000											% Нежелательность разрыва страницы после первой строки абзаца
\widowpenalty=10000											% Нежелательность разрыва страницы перед последней строкой абзаца
\brokenpenalty=10000										% Запрет на перенос на другую страницу
\parfillskip=0pt plus .9\textwidth			% Не даст последней строчке быть слишком короткой
