...
% Оборот титула
	...
	\begin{minipage}[t]{\linewidth-1em-\widthof{\AuthorMark}}
		...
		\small\hspace{1.5em} В~качестве фона для˚обложки использована картина Ары Нориковича Хачатряна «Ветер» (год создания "--- 2005, размер 30х50 см., картон/масло). Право использовать картину при оформлении книги передано на основании лицензионного договора от 13.12.2018.
	\end{minipage}
